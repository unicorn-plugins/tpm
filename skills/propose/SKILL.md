...
- **각 Phase 시작 시**: `CLAUDE.md`의 해당 Phase 상태를 `🔄 진행 중`으로 업데이트
- **각 Phase 완료 시**: `CLAUDE.md`의 해당 Phase 상태를 `✅ 완료`로 업데이트
- **진행 상황 표시 시**: `CLAUDE.md`를 Read 도구로 읽어 `## 진행 상황` 섹션을 그대로 출력
- **작품명 표시**: Phase 0 완료 후 `CLAUDE.md`의 `## 진행 상황` 섹션 위에 `### 작품명: {작품명}` 한 줄 추가
...
5. `CLAUDE.md`의 `## 진행 상황` 섹션에 `### 작품명: {작품명}` 추가 및 전체 Phase 상태를 `⬜ 대기`로 초기화
