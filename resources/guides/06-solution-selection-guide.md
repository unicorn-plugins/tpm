...
| 산출물 | 파일 경로 | 활용 방법 |
|--------|----------|----------|
| 공연 컨셉 후보 | `output/{작품명}/05-컨셉후보.md` | 투표 및 평가 대상 컨셉 목록 |
...
4. 최소 1개는 반드시 Needs Statement(04-방향성.md)와 강하게 연결되어야 함
...
- 선정된 컨셉이 04-방향성.md의 Needs Statement를 달성할 수 있는지 최종 검증
